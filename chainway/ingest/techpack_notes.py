...
PLACEMENT_PATTERNS = {
    "門襟": r"門襟|前襟",      # 實測 49 份，1.5%
    "領台": r"領台|領座",      # 實測 7 份，0.2%
    "口袋": r"口袋(?!深|寬|高)",  # 實測 163 份，5.0%
    "滾邊": r"滾邊",           # 實測 59 份，1.8%
}
# 刻意不收「下擺／下襬」：實測命中 896 份（27.4%），因為 hem_width 的
# 中文欄位名就是「下擺」，填答率 22.3%。跟「袖口」「請對格子」同性質 ——
# 尺寸表的欄位標題，不是設計註記。第一版收了它，覆蓋率高得不合理才發現。
