...
rem ===================================================================
rem  Kinloch Anderson - image match audit (why some styles have no photo)
rem
...
rem ===================================================================
cd /d "%~dp0"
title Kinloch Anderson - image match audit
...
echo.
echo  ==================================================================
echo   Step 3 of 3  -  auditing the image library
echo  ==================================================================
rem The master table has to be current, otherwise styles added since the
rem last run would be reported as having no photo.
...
start "" "%OUT%"
echo.
echo   Open the folder that the line above names. Every row in the first
echo   CSV is a style with no photo, the reason, and the filename it
echo   nearly matched - so it can be checked directly.
echo.
pause
exit /b 0
